...
public class CachinitaBallComentado 
{
	...
	public static void main(String[] args) 
	{
		...
		do
		{
			...
			//aqui se resuelve el problema defino la ecuacion de una recta que pasa por 2 puntos calculando A, B y C
			for (int k=0 ; k<N; k++)
			{
				...
				//la pendiente de la recta original es -A/B y su perpencicular resulta de multiplicarla por -1/m luego queda B/A
